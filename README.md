...
# wGraphBasic [![Build Status](https://travis-ci.org/Wandalen/wGraphBasic.svg?branch=master)](https://travis-ci.org/Wandalen/wGraphBasic) [![Build Status](https://ci.appveyor.com/api/projects/status/github/Wandalen/wabstractgraph)](https://ci.appveyor.com/project/Wandalen/wabstractgraph)
